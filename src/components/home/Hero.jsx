...
const Hero = () => {
    ...
    return (
        <section className='flex flex-col md:flex-row justify-between bg-[#282B2E] pt-12 md:pt-28 lg:pt-28'>
                ...
                <div className='flex flex-col gap-4 md:gap-6 py-10 md:py-6 lg:py-12 items-center md:items-start'>
                    ...
                    <div className='flex flex-col gap-2 lg:gap-4 text-white items-center md:items-start'>
                        ...
                        <button
                            ...
                            data-aos-easing="linear"
                            data-aos-duration="1000"
                            className="py-1 md:py-1.5 lg:py-2 px-4 lg:px-8 bg-[#FF0000] outline-none font-extralight hover:font-medium text-xs md:text-sm lg:text-base w-fit">Get Started</button>
                    </div>
                </div>
            </div>
