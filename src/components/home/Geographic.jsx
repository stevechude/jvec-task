            ...
            <div className='lg:px-16 lg:py-6 md:p-4 md:py-8 p-2 py-8'>
                <div className='flex flex-col gap-6 items-center'>
                    ...
                    <div className='relative'>
                        ...
                        <div style={{ boxShadow: "0px 0px 5px 1px #ccc" }} className='bg-white rounded-lg w-fit text-black absolute top-0 md:top-4 lg:top-8'>
                        ...
                        <div style={{ boxShadow: "0px 0px 5px 1px #ccc" }} className='bg-white rounded-lg w-fit text-black absolute bottom-16 md:bottom-16 lg:bottom-40 right-0'>
